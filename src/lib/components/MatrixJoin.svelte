...
<div class="flex flex-col">
	...
	<a type="button" class="btn variant-filled-success mx-auto" href={PUBLIC_ELEMENT_LINK} target="element" on:click={() => $hasOpenedElement = true} on:auxclick={(e) => {
		if (e.button == 1) {
			$hasOpenedElement = true;
		}
	}}>
